...
public class ExportPagpapatunay {
    ...
    public static void main(String[] args) {
        ...
        try {
            String lsSQL = "SELECT"
                    ...
                    + ", IFNULL(z.sBranchNm, '') xBranchName "
                    ...
                    + " LEFT JOIN Branch z on a.sBranchCd = z.sBranchCd"
            ...
            if (loRS.next()) {
                 ...
                 * =====================================================
                 */
                String lsTemplate = "Pagpapatunay";
                ...
                form.setField("CustomerName2",lsCustomer.toUpperCase());
                form.setField("CustomerSignature",lsCustomer.toUpperCase());
                form.setField("Branch",loRS.getString("xBranchName").toUpperCase());
                form.setField("Branch",loRS.getString("xBranchName").toUpperCase());
                
                form.setField("Date",date.toString());
                form.setField("Petsa",date.toString());
                form.setField("Petsa_2",date.toString());
                form.setField("Petsa_3",date.toString());
