...
public class ExportConsentForm {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (loRS.next()) {
                 ...
                 * =====================================================
                 */
                String lsTemplate = "Consent Form (DocuSign)";
                ...
                form.setField("COMPLETENAME",lsCustomer.toUpperCase());
                if(!gocas.ApplicantInfo().getMobileNo(0).isEmpty()){
                    form.setField("CONTACTNO",gocas.ApplicantInfo().getMobileNo(0));
                }
                
                if(!gocas.ApplicantInfo().getEmailAddress(0).isEmpty()){
                    form.setField("EMAIL",lsCustomer.toUpperCase());
                }
                ...
                form.setField("ADDRESS", lsValue.trim().toUpperCase());
                /*
                 * =====================================================
                 * WITNESSES
                 * =====================================================
